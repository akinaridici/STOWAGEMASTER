...
class AppConfig:
    ...
    def from_dict(cls, data: Dict) -> 'AppConfig':
        ...
        return cls(
            ...
            backup_directory=Path(data['backup_directory']) if data.get('backup_directory') else None,
            log_directory=Path(data['log_directory']) if data.get('log_directory') else None,
